...
res_bm8_weekly <- data.frame(Series=sn, sMAPE=Total_sMAPE, MASE=Total_MASE)
write.csv(res_bm8_weekly, file="results/benchmarks/results_bm8_weekly.csv")

res_table_bm8_weekly <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(res_table_bm8_weekly, file="results/benchmarks/results_bm8_weekly_table.csv")
