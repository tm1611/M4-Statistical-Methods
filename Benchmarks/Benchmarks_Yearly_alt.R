...
res_bm8_yearly <- data.frame(Series=sn, sMAPE=Total_sMAPE, MASE=Total_MASE)
write.csv(res_bm8_yearly, file="results/benchmarks/results_bm8_yearly.csv")

res_table_bm8_yearly <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(res_table_bm8_yearly, file="results/benchmarks/results_bm8_yearly_table.csv")
