...
results_bm8_Finance <- data.frame(Series=st, insample_n=n, period=period, sMAPE=Total_sMAPE, MASE=Total_MASE)
write.csv(results_bm8_Finance, file="results/M4_benchmarks8/results_bm8_Finance.csv")

results_table_bm8_Finance <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(results_table_bm8_Finance, file="results/M4_benchmarks8/results_bm8_Finance_table.csv")
