...
results_bm8_Industry <- data.frame(Series=st, insample_n=n, period=period, sMAPE=Total_sMAPE, MASE=Total_MASE)
write.csv(results_bm8_Industry, file="results/M4_benchmarks8/results_bm8_Industry.csv")

results_table_bm8_Industry <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(results_table_bm8_Industry, file="results/M4_benchmarks8/results_bm8_Industry_table.csv")
