...
results_bm8_Macro <- data.frame(Series=st, insample_n=n, period=period, sMAPE=Total_sMAPE, MASE=Total_MASE)
write.csv(results_bm8_Macro, file="results/M4_benchmarks8/results_bm8_Macro.csv")

results_table_bm8_Macro <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(results_table_bm8_Macro, file="results/M4_benchmarks8/results_bm8_Macro_table.csv")
