...
results_bm8_Micro <- data.frame(Series=st, insample_n=n, period=period, sMAPE=Total_sMAPE, MASE=Total_MASE)
write.csv(results_bm8_Micro, file="results/M4_benchmarks8/results_bm8_Micro.csv")

results_table_bm8_Micro <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(results_table_bm8_Micro, file="results/M4_benchmarks8/results_bm8_Micro_table.csv")
