...
write.csv(results, file="results/M4_benchmarks8_Subsets/Benchmarks8_Monthly_Other.csv")

results_table <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(results_table, file="results/M4_benchmarks8_Subsets/Benchmarks8_Monthly_Other_table.csv")
