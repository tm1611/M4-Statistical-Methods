...
results_bm8_Other <- data.frame(Series=st, insample_n=n, period=period, sMAPE=Total_sMAPE, MASE=Total_MASE)
write.csv(results_bm8_Other, file="results/M4_benchmarks8/results_bm8_Other.csv")

results_table_bm8_Other <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(results_table_bm8_Other, file="results/M4_benchmarks8/results_bm8_Other_table.csv")
