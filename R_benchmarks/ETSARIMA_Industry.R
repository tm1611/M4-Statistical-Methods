...
write.csv(results_Industry, file="results/M4_ETSARIMA/results_Industry.csv")

results_table_Industry <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(results_table_Industry, file="results/M4_ETSARIMA/results_table_Industry.csv")
