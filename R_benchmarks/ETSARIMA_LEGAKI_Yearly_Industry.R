### ETSARIMA_Legaki Yearly_Industry ###
rm(list=ls())
graphics.off()
library(forecast)
library(ggplot2)
...
# load data
my_data <- "data/M4_Yearly_Industry.rds"
...
write.csv(ETSARIMA_Legaki, file="results/M4_ETSARIMA_Legaki/ETSARIMA_Legaki_Yearly_Industry.csv")

Res_table_quarterly <- my_accuracy(Total_sMAPE, Total_MASE)
write.csv(Res_table_quarterly, file="results/M4_ETSARIMA_Legaki/ETSARIMA_Legaki_Yearly_Industry_table.csv")
